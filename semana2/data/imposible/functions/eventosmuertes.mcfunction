...
execute as @a[scores={muertes=125}] run effect give @a[scores={muertes=125}] hunger 15
execute as @a[scores={muertes=125}] run effect give @a[scores={muertes=125}] weakness 15 1
execute as @a[scores={muertes=125}] run effect give @a[scores={muertes=125}] bad_omen 15 1
execute as @a[scores={muertes=125}] run effect give @a[scores={muertes=125}] unluck 30 19
execute as @a[scores={muertes=125}] run effect give @a[scores={muertes=125}] poison 30
execute as @a[scores={muertes=125}] run effect give @a[scores={muertes=125}] mining_fatigue 15
execute as @a[scores={muertes=126}] run tellraw @a[scores={muertes=126}] {"text":"Has alcanzado el limite de muertes, se te establecen las muertes en 125","color":"red"}
execute as @a[scores={muertes=126}] run scoreboard players set @a[scores={muertes=126}] muertes 125
execute as @a[scores={muertes=127}] run scoreboard players set @a[scores={muertes=127}] muertes 125
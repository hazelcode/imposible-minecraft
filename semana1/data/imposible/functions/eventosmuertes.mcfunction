...
execute as @a[scores={muertes=100}] run effect give @a[scores={muertes=100}] hunger 15
execute as @a[scores={muertes=100}] run effect give @a[scores={muertes=100}] weakness 15 1
execute as @a[scores={muertes=100}] run effect give @a[scores={muertes=100}] bad_omen 15 1
execute as @a[scores={muertes=100}] run effect give @a[scores={muertes=100}] unluck 30 19
execute as @a[scores={muertes=100}] run effect give @a[scores={muertes=100}] poison 30
execute as @a[scores={muertes=100}] run effect give @a[scores={muertes=100}] mining_fatigue 15
execute as @a[scores={muertes=101}] run tellraw @a[scores={muertes=101}] {"text":"Has alcanzado el limite de muertes, se te establecen las muertes en 100","color":"red"}
execute as @a[scores={muertes=101}] run scoreboard players set @a[scores={muertes=101}] muertes 100
execute as @a[scores={muertes=102}] run scoreboard players set @a[scores={muertes=102}] muertes 100
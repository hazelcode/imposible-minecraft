...
execute as @a[scores={muertes=150}] run effect give @a[scores={muertes=150}] hunger 15
execute as @a[scores={muertes=150}] run effect give @a[scores={muertes=150}] weakness 15 1
execute as @a[scores={muertes=150}] run effect give @a[scores={muertes=150}] bad_omen 15 1
execute as @a[scores={muertes=150}] run effect give @a[scores={muertes=150}] unluck 30 19
execute as @a[scores={muertes=150}] run effect give @a[scores={muertes=150}] poison 30
execute as @a[scores={muertes=150}] run effect give @a[scores={muertes=150}] mining_fatigue 15
execute as @a[scores={muertes=151}] run tellraw @a[scores={muertes=151}] {"text":"Has alcanzado el limite de muertes, se te establecen las muertes en 150","color":"red"}
execute as @a[scores={muertes=126}] run scoreboard players set @a[scores={muertes=151}] muertes 150
execute as @a[scores={muertes=127}] run scoreboard players set @a[scores={muertes=152}] muertes 150